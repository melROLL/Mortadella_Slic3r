 ...
 * is set to true.
 **/
_VASE_CONFIG.BEZIER_CANVAS_WIDTH          = 400;
_VASE_CONFIG.BEZIER_CANVAS_HEIGHT         = 600;

_VASE_CONFIG.PREVIEW_CANVAS_WIDTH         = 400;
_VASE_CONFIG.PREVIEW_CANVAS_HEIGHT        = 600;
 ...
 * Valid values: true|false
 **/
_VASE_CONFIG.HIDE_SAVE_FILE_ITEM         = false; 
 ...
 * Valid values: true|false
 **/
_VASE_CONFIG.HIDE_LOAD_FILE_ITEM         = false; 
