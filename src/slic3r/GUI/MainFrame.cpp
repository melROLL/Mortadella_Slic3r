...
static wxMenu* generate_other_menu()
{
    ...
    append_menu_item(otherMenu, wxID_ANY, wxString::Format(_L("Wasp Manual")), wxString::Format(_L("Open the %s releases page in your browser"), SLIC3R_APP_NAME),
        [](wxCommandEvent&) { wxGetApp().open_browser_with_warning_dialog(SLIC3R_DOWNLOAD, nullptr, false); });
    append_menu_item(otherMenu, wxID_ANY, wxString::Format(_L("vase generator")), wxString::Format(_L("Open the %s wiki in your browser"), SLIC3R_APP_NAME),
        [](wxCommandEvent&) { wxGetApp().open_browser_with_warning_dialog("http://github.com/" SLIC3R_GITHUB "/wiki"); });
